...
def main(year):
    ...
    timeseries_query(
        url=url,
        query='agg=year&dataset_name=crimes_2001_to_present&obs_date__ge=' + year + '-1-1',
    ...
    timeseries_query(
        url=url,
        query='agg=year&dataset_name=nypd_motor_vehicle_collisions&obs_date__ge=' + year + '-1-1',
    ...
    timeseries_query(
        url=url,
        query='agg=week&dataset_name=sfpd_incidents_from_1_january_2003&obs_date__ge=' + year + '-1-1',
